...
class eclApp_bookstoreAdminUsuarios extends eclApp
{
    ...
    public static $map = ['bookstoreAdminUsuarios_usuariosCadastrar', 'bookstoreAdminUsuarios_usuariosTodos', 'bookstoreAdminUsuarios_gruposCadastrar', 'bookstoreAdminUsuarios_gruposTodos', 'bookstoreAdminUsuarios_detalhes'];
