...
class eclApp_bookstoreAdminUsuarios extends eclApp {
    ...
    static map = ['bookstoreAdminUsuarios_usuariosCadastrar', 'bookstoreAdminUsuarios_verificarLista', 'bookstoreAdminUsuarios_usuariosTodos', 'bookstoreAdminUsuarios_detalhes'];
